...
self::logdebug('getMediaLocal PHASE 1 - syncId=: '.$syncId);
            ...
            try {
                $flagToRelease=self::checkAndGetLock('getMediaLocal-Phase1-syncId-'.$syncId,100);
...
file_put_contents($folderJson,json_encode($jsonrep));
jeedomUtils.sleep(1);
self::logdebug('getMediaLocal PHASE 1 - syncId=: '.$syncId.' - result: '.print_r($jsonrep,true));
